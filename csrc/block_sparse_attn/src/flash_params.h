...
struct Flash_fwd_params {
    ...
    int k_h;
    int k_w;
    void *__restrict__ rel_h_ptr;
    index_t rel_h_batch_stride;
    index_t rel_h_head_stride;
    index_t rel_h_row_stride;
    index_t rel_h_col_stride;
    int rel_h_last_dim;
    void *__restrict__ start_index_block_tile_rel_h;

    void *__restrict__ rel_w_ptr;
    index_t rel_w_batch_stride;
    index_t rel_w_head_stride;
    index_t rel_w_row_stride;
    index_t rel_w_col_stride;
    int rel_w_last_dim;
    void *__restrict__ start_index_block_tile_rel_w;
