"""
Block Sparse Attention Setup

Optimized for vision transformers like SAM with proper linking to PyTorch libraries.
"""
...
if not SKIP_CUDA_BUILD:
    ...
    if CUDA_HOME is not None:
        ...
        if bare_metal_version < Version("11.7"):
            raise RuntimeError(
                "Block Sparse Attention requires CUDA 11.7 or above. "
    ...
    fused_pos_sources = [
        "csrc/block_sparse_attn/flash_api_fused_pos.cpp",
        "csrc/block_sparse_attn/src/flash_fwd_hdim64_fp16_fused_pos.cu",
    ]

    ext_modules.append(
        CUDAExtension(
            name="block_sparse_attn_fused_pos_cuda",
            sources=fused_pos_sources,
            extra_compile_args={
                "cxx": compiler_c17_flag,
                "nvcc": append_nvcc_threads(nvcc_flags + cc_flag),
            },
    ...
    fused_pos_local_sources = [
        "csrc/block_sparse_attn/flash_api_fused_pos_local.cpp",
        "csrc/block_sparse_attn/src/flash_fwd_hdim64_fp16_fused_pos_local.cu",
    ]

    ext_modules.append(
        CUDAExtension(
            name="block_sparse_attn_fused_pos_local_cuda",
            sources=fused_pos_local_sources,
            extra_compile_args={
                "cxx": compiler_c17_flag,
                "nvcc": append_nvcc_threads(nvcc_flags + cc_flag),
            },
...
setup(
    ...
    author="Hoai-Chau Tran and Huu-Chi Nguyen",
